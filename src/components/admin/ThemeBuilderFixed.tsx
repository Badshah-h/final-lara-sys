...
const ThemeBuilderFixed = () => {
  ...
  const handleCopyTheme = () => {
    // Generate CSS variables based on theme values
    const cssVariables = `
:root {
  ...
  const applyPresetTheme = (preset) => {
    setActiveTheme(preset.name.toLowerCase().replace(" ", "-"));
    setThemeValues((prev) => ({
      ...prev,
            ...
            <CardContent className="p-0">
              ...
              <div className="h-[400px] relative bg-muted/20 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className={`w-full h-full ${activePreview === "mobile" ? "max-w-[320px]" : "max-w-md"} mx-auto p-4`}
                    style={{
                      fontFamily: themeValues.fontFamily,
                    }}
                  >
...
export default ThemeBuilderFixed;
