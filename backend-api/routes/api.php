...
use App\Http\Controllers\API\DirectAuthController;
...
// Authentication routes - IMPORTANT: No rate limiting or throttling applied
// These routes are explicitly excluded from CSRF protection and rate limiting
Route::post('/register', [AuthController::class, 'register']);
Route::post('/login', [AuthController::class, 'login']);
Route::post('/logout', [AuthController::class, 'logout']);
Route::middleware('auth:sanctum')->get('/user', [AuthController::class, 'user']);

// Direct authentication routes for testing
Route::post('/direct/login', [DirectAuthController::class, 'login']);
Route::post('/direct/logout', [DirectAuthController::class, 'logout']);
Route::get('/direct/user', [DirectAuthController::class, 'user'])->middleware('auth:sanctum');

// No CSRF authentication routes - completely bypass CSRF protection
Route::post('/nocsrf/login', [NoCSRFAuthController::class, 'login']);
Route::post('/nocsrf/register', [NoCSRFAuthController::class, 'register']);
Route::post('/nocsrf/logout', [NoCSRFAuthController::class, 'logout']);
Route::get('/nocsrf/user', [NoCSRFAuthController::class, 'user']);

// Completely public routes with no protection at all
Route::post('/public/login', [PublicAuthController::class, 'login']);
Route::post('/public/register', [PublicAuthController::class, 'register']);
Route::post('/public/logout', [PublicAuthController::class, 'logout']);
Route::get('/public/user', [PublicAuthController::class, 'user']);

// CSRF test route - no rate limiting
...
// Public API endpoints with no middleware
Route::get('/public/users', [\App\Http\Controllers\API\UserController::class, 'publicList']);
